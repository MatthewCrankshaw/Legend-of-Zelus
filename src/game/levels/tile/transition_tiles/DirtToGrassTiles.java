...
public class DirtToGrassTiles extends TransitionTiles {
    ...
    public void setTiles() {
        Sprite NW_Diagonal = new Sprite(8, 0, 0, SpriteSheet.dirtToGrass);
        Sprite NE_Diagonal = new Sprite(8, 1, 0, SpriteSheet.dirtToGrass);
        Sprite SW_Diagonal = new Sprite(8, 0, 1, SpriteSheet.dirtToGrass);
        Sprite SE_Diagonal = new Sprite(8, 1, 1, SpriteSheet.dirtToGrass);

        Sprite NW_Corner = new Sprite(8, 2, 0, SpriteSheet.dirtToGrass);
        Sprite NE_Corner = new Sprite(8, 3, 0, SpriteSheet.dirtToGrass);
        Sprite SW_Corner = new Sprite(8, 2, 1, SpriteSheet.dirtToGrass);
        Sprite SE_Corner = new Sprite(8, 3, 1, SpriteSheet.dirtToGrass);

        Sprite northEdge = new Sprite(8, 1, 2, SpriteSheet.dirtToGrass);
        Sprite westEdge = new Sprite(8, 0, 3, SpriteSheet.dirtToGrass);
        Sprite eastEdge = new Sprite(8, 3, 3, SpriteSheet.dirtToGrass);
        Sprite southEdge = new Sprite(8, 1, 5, SpriteSheet.dirtToGrass);

        Sprite solidGrass1 = new Sprite(8, 1, 3, SpriteSheet.dirtToGrass);
        Sprite solidGrass2 = new Sprite(8, 2, 3, SpriteSheet.dirtToGrass);
